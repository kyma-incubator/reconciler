...
kyma_get_previous_release_version_return_version=$(git ls-remote --refs --sort="version:refname" --tags "https://api.github.com/repos/kyma-project/kyma" | cut -d/ -f3-|tail -n1)
