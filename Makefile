...
deploy:
	...
	helm template reconciler --namespace reconciler --set "global.components={istio,busolamigrator,simpletestcomponent,base}" ./resources/reconciler > reconciler.yaml
