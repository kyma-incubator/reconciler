...
import (
	...
	//import required to register component reconciler 'provisioning' in reconciler registry
	_ "github.com/kyma-incubator/reconciler/pkg/reconciler/instances/provisioning"
