...
//	}
//
//	oidcConfig, err := toOIDCConfig(configuration)
//
...
//}
//
//func toOIDCConfig(configuration map[string]interface{}) (*gardener.OIDCConfig, error) {
//	clientID, err := getStringPointerKey(configuration, "oidcConfig.clientID")
//	if err != nil {
//		return nil, err
//	}
//
//	groupsClaim, err := getStringPointerKey(configuration, "oidcConfig.groupsClaim")
//	if err != nil {
//		return nil, err
//	}
//
//	issuerURL, err := getStringPointerKey(configuration, "oidcConfig.issuerURL")
//	if err != nil {
//		return nil, err
//	}
//
//	signingAlgs, err := getStringSliceKey(configuration, "oidcConfig.signingAlgs")
//	if err != nil {
//		return nil, err
//	}
//
//	usernameClaim, err := getStringPointerKey(configuration, "oidcConfig.usernameClaim")
//	if err != nil {
//		return nil, err
//	}
//
//	usernamePrefix, err := getStringPointerKey(configuration, "oidcConfig.usernamePrefix")
//	if err != nil {
//		return nil, err
//	}
//
//	if clientID != nil && groupsClaim != nil && issuerURL != nil && signingAlgs != nil && usernameClaim != nil && usernamePrefix != nil {
...
//}
//
//func toProviderSpecificConfig(configuration map[string]interface{}) (*gardener.ProviderSpecificConfig, error) {
//	gcpZones, err := getStringSliceKey(configuration, "gcp.zones")
//	if err != nil && gcpZones != nil {
//		return &gardener.ProviderSpecificConfig{
//			GCP: &gardener.GCPProviderConfig{
//				Zones: gcpZones,
//			},
//		}, nil
//	}
//
//	azureZones, err := getStringSliceKey(configuration, "azure.zones")
//
//}
//
...
//}
//
//func getStringSliceKey(configuration map[string]interface{}, keyName string) ([]string, error) {
//	val, ok := configuration[keyName]
//	if !ok {
//		return nil, nil
//	}
...
//	valString, ok := val.([]string)
//	if !ok {
//		return nil, errors.New(fmt.Sprintf("string slice value type expected for key %s", keyName))
//	}
//
//	return valString, nil
//}
