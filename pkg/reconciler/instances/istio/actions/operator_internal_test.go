...
func Test_IstioOperator(t *testing.T) {
	provider := clientset.DefaultProvider{}

	op, err := manifest.ExtractIstioOperatorContextFrom(operatorManifest)

  require.NoError(t, err)

	needed, err := upgradeNeeded(&provider, op, nil, &zap.SugaredLogger{})
