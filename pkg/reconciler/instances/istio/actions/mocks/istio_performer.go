...
// ResetProxy provides a mock function with given fields: _a0, kubeConfig, proxyImageVersion, proxyImagePrefix, logger, canUpdate
func (_m *IstioPerformer) ResetProxy(_a0 context.Context, kubeConfig string, proxyImageVersion string, proxyImagePrefix string, logger *zap.SugaredLogger, canUpdate bool) error {
	ret := _m.Called(_a0, kubeConfig, proxyImageVersion, proxyImagePrefix, logger, canUpdate)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, *zap.SugaredLogger, bool) error); ok {
		r0 = rf(_a0, kubeConfig, proxyImageVersion, proxyImagePrefix, logger, canUpdate)
	} else {
		r0 = ret.Error(0)
	}
...
// NewIstioPerformer creates a new instance of IstioPerformer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIstioPerformer(t testing.TB) *IstioPerformer {
	mock := &IstioPerformer{}
	mock.Mock.Test(t)
