...
// Install provides a mock function with given fields: kubeConfig, istioOperatormanifest, version, logger
func (_m *IstioPerformer) Install(kubeConfig string, istioOperatormanifest string, version string, logger *zap.SugaredLogger) error {
	ret := _m.Called(kubeConfig, istioOperatormanifest, version, logger)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, *zap.SugaredLogger) error); ok {
		r0 = rf(kubeConfig, istioOperatormanifest, version, logger)
	} else {
		r0 = ret.Error(0)
	}
...
// Update provides a mock function with given fields: kubeConfig, istioOperatorManifest, version, logger
func (_m *IstioPerformer) Update(kubeConfig string, istioOperatorManifest string, version string, logger *zap.SugaredLogger) error {
	ret := _m.Called(kubeConfig, istioOperatorManifest, version, logger)
