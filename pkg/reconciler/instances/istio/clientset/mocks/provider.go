...
// GetDynamicClient provides a mock function with given fields: kubeConfig
func (_m *Provider) GetDynamicClient(kubeConfig string) (dynamic.Interface, error) {
	ret := _m.Called(kubeConfig)

	var r0 dynamic.Interface
	if rf, ok := ret.Get(0).(func(string) dynamic.Interface); ok {
		r0 = rf(kubeConfig)
	} else {
		if ret.Get(0) != nil {
