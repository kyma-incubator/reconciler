...
// NewGatherer creates a new instance of Gatherer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGatherer(t testing.TB) *Gatherer {
	mock := &Gatherer{}
	mock.Mock.Test(t)
