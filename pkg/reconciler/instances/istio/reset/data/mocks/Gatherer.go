...
func (_m *Gatherer) GetPodsWithDifferentImage(inputPodsList v1.PodList, image data.ExpectedImage) (v1.PodList, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(v1.PodList, data.ExpectedImage) error); ok {
		r1 = rf(inputPodsList, image)
	} else {
		r1 = ret.Error(1)
	}
