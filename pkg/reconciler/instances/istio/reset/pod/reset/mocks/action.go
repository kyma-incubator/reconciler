...
// LabelWithWarning provides a mock function with given fields: _a0, kubeClient, retryOpts, podsList, log, debug, waitOpts
func (_m *Action) LabelWithWarning(_a0 context.Context, kubeClient kubernetes.Interface, retryOpts []retry.Option, podsList v1.PodList, log *zap.SugaredLogger, debug bool, waitOpts pod.WaitOptions) error {
