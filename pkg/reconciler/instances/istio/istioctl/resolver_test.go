...
func Test_DefaultIstioctlResolver(t *testing.T) {
	t.Run("should match exact version if it exists", func(t *testing.T) {
		...
		vc.On("GetIstioVersion", "/d").Return(helpers.HelperVersion{Library: "istioctl", Tag: first(semver.NewVersion("1.2.1"))},nil)
		vc.On("GetIstioVersion", "/c").Return(helpers.HelperVersion{Library: "istioctl", Tag: first(semver.NewVersion("1.2.4"))},nil)
		vc.On("GetIstioVersion", "/b").Return(helpers.HelperVersion{Library: "istioctl", Tag: first(semver.NewVersion("1.2.7"))},nil)
		vc.On("GetIstioVersion", "/a").Return(helpers.HelperVersion{Library: "istioctl", Tag: first(semver.NewVersion("1.11.2"))},nil)
