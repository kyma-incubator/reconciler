...
func (q *QueryGorm) ColumnValues(onlyWriteable bool) ([]interface{}, error) {
	return q.columnHandler.ColumnValues(onlyWriteable)
}

func (q *QueryGorm) ColumnMap(onlyWriteable bool) map[string]interface{} {
	res := make(map[string]interface{})
	values, _ := q.ColumnValues(onlyWriteable)
