...
func (r *PersistentReconciliationRepository) CreateWorkerPoolOccupancy(poolSize int) (string, error) {
...
func (r *PersistentReconciliationRepository) UpdateWorkerPoolOccupancy(poolId string, runningWorkers int) error {
...
func (r *PersistentReconciliationRepository) GetMeanWorkerPoolOccupancy() (float64, error) {
...
func (r *PersistentReconciliationRepository) RemoveWorkerPoolOccupancy(poolId string) error {
	dbOps := func(tx *db.TxConnection) error {
