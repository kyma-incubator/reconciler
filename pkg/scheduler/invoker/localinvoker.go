...
//	operationsReg scheduler.OperationsRegistry
//	logger        *zap.SugaredLogger
//	statusFunc    ReconcilerStatusFunc
//}
//
//func (lri *localReconcilerInvoker) Invoke(ctx context.Context, params *Params) error {
...
//			"using '%s' component reconciler as fallback", component, scheduler.DefaultReconciler)
//		componentReconciler, err = service.GetReconciler(scheduler.DefaultReconciler)
//		if err != nil {
//			lri.logger.Errorf("Fallback component reconciler '%s' is missing: "+
//				"check local component reconciler initialization", scheduler.DefaultReconciler)
//			return err
//		}
//	}
//
...
//}
//
//func (lri *localReconcilerInvoker) createCallbackFunc(params *Params) func(msg *reconciler.CallbackMessage) error {
